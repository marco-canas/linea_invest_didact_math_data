# Plan de acción del área de Matemáticas: Profesor Marco Julio Cañas 2025  

## Investigación  
Trabajo como coinvestigador en SAT Dengue.  
2. Conferencia sobre desarrollo de habilidades de investigación cuantitativa y cuatitativa con herramientas de código abieto asociadas a Python.  
3. Trabajo como asesor a trabajo de Grado de Janis Zúñiga Ortega en su trabajo de Grado de Biología. 
## Docencia
Tres cursos para pregrado. 
Dos para la facultad de educación
Uno para la Facultad de Ciencias Agrarias. 

## Extensión   
  
**Objetivo**: **Capacitar a docentes, estudiantes y comunidad investigativa** en la región en técnicas de **ciencia de datos, Machine Learning y Deep Learning con lenguaje Python** 
aplicadas a la educación y a problemas del sector productivo.  

**Acciones:**  
- Organización de **talleres** presenciales y virtuales dirigidos a **docentes, investigadores y estudiantes** Para promover la importancia de la toma de datos estructurada, pues esta facilita la investigación.    
...
### **1. Docencia**  
**Objetivo**: Fomentar el **pensamiento variacional y computacional** en estudiantes de **Ingeniería Agropecuaria, Licenciatura en Matemáticas, Licenciatura en Educación Infantil y Administración de Empresas**
